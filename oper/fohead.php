...
@media only screen and (max-width:800px), (min-device-width:768px) and (max-device-width:1024px) {
	...
	/* Behave like a row */
	#rep_thead td, #rep_tbody td { padding-left:50%; padding-right:3px; position:relative; }
	/* Now like a table header */
	#rep_thead td:before, #rep_tbody td:before { left:5px; padding-right:10px; position:absolute; top:7px; white-space:nowrap; width:45%; }";
