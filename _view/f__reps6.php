<?php
?>
<!-- DF_ajs: Reports Tab 6 (Export) Form -->
<!DOCTYPE html>
<html>
<head>
...
<title>[2017:0214]&nbsp;Звіти - Інтернет-Ферма</title>
...
<div class='section group'>
	<div class='col span_1_of_2'>
		<div id='list'>
		<ul>
			<li><a href='../reports/f_e003.php?&select_table=f_cows&select_field=c.id&title=UNIFORM+Agri' target='w1'>UNIFORM Agri</a></li>
		</ul>
		</div>
	</div>
