...
<!--	<h3 class="text-center">Cows</h3>-->
	<div class="alert navbar-brand">
		<button class="btn btn-primary" style="border-radius:0; padding-left:10px; padding-right:10px;" ng-show="show_form" ng-click="Cw_add_form_show();">Додати&nbsp;&nbsp;<span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
	</div>
...
<!-- Form template which is used to insert data -->
	<form class="alert alert-warning" id="cw_add_form" name="cw_add" <?php echo $_form_content_style;?> hidden>
...
<!-- Form template which is used to edit and update data -->
	<form class="alert alert-warning" id="cw_edit_form" name="cw_edit" <?php echo $_form_content_style;?> hidden>
		<div <?php echo $_card_content_style;?>>
<?php
include( "f__cw_e.htm" );
?>
...
<!-- Cows List -->
	<div class="table-responsive" id="cws_list" <?php echo $_content_style;?>>
		...
		<tr>
			...
			<th width="80px">№</th>
			<th>Прізв.</th>
			<th width="100px">Дата народж.</th>
			<th>№ новонародж.</th>
		</tr>
		<tr ng-repeat="detail in details | filter:search_query">
			<td style="padding-left:16px;"><button class="btn btn-warning" style="border-radius:0; padding-left:10px; padding-right:10px;" title="Edit" ng-click="Cw_edit_form_show(detail);"><span class="glyphicon glyphicon-edit"></span></button></td>
			<td><button class="btn btn-danger" style="border-radius:0; padding-left:10px; padding-right:10px;" title="Delete" ng-disabled="detail.id==1 || detail.locked.length>0" ng-click="db_Cw_delete(detail);"><span class="glyphicon glyphicon-trash"></span></button></td>
