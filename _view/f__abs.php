<?php
$ANGULAR_IS_USED=1;
$HTML_COMMENT="<!-- DF_ajs: Breeds Form -->";
$HTML_TAG="<html ng-app='f_bs'>";
...
<nav1>
	<div id='cssmenu1'>
		<ul>
			...
			<li class='active'><a href='f__abs.php'><span>Породи</span></a></li>
...
<!--	<h3 class="text-center">Breeds</h3>-->
	<div class="alert navbar-brand">
		<button class="btn btn-primary" ng-show="show_form" ng-click="B_add_form_show()">Add&nbsp;&nbsp;<span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
	</div>
...
<!-- Form template which is used to insert data -->
		<div ng-include src="'f__ab_a.htm'"></div>
<!-- Form template which is used to edit and update data -->
		<div ng-include src="'f__ab_e.htm'"></div>
	</div>
	<div class="clearfix"></div>
<!-- Breeds List -->
	<div class="table-responsive" id="bs_list" <?php echo $_content_style;?>>
		...
		<tr ng-repeat="detail in details | filter:search_query">
			<td><button class="btn btn-warning" title="Edit Breed" ng-click="B_edit_form_show(detail)"><span class="glyphicon glyphicon-edit"></span></button></td>
			<td><button class="btn btn-danger" title="Delete Breed" ng-disabled="detail.id==1" ng-click="db_B_delete(detail)"><span class="glyphicon glyphicon-trash"></span></button></td>
			<td>{{detail.nick}}</td>
			<td>{{detail.num}}</td>
		</tr>
		</table>
