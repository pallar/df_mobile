...
<title>Интернет-Ферма. Инструкция. Селекционные ворота</title>
</head>
<?php
...
<li>собственно механика ворот.</li>
</ul>
</p>
...
<li>контролировать работу раскола можно в реальном времени на мнемосхеме доильного зала.</li>
</ul>
		</div></div>
