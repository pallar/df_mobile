...
#rep_thead td, rep_tbody td { border:1px solid #ddd; }
...
@media only screen and (max-width:800px), (min-device-width:768px) and (max-device-width: 1024px) {
	...
	#rep_tbody tr#, rep_tfoot tr { border:0; }
	/* Behave like a row */
	...
	#rep_tbody td:before,#rep_tfoot td:before { left:5px; padding-right:10px; position:absolute; top:6px; white-space:nowrap; width:45%; }";
