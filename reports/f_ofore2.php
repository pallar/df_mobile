...
if ( $dontuse_period==4 ) {
	$du_p=0; $href_title_=$ged['r-td-Zapusk_Plan_From_To'];
} elseif ( $dontuse_period==1 ) {
	$du_p=1; $href_title_=$ged['r-td-Prep_Zapusk_Plan'];
} else {
	$du_p=4; $href_title_=$ged['r-td-Zapusk_Plan'];
}
...
<tr $cjust class='st_title2' style='height:28px'>
	...
	<td><b>".$ged['Nick']."</b></td>
	<td><b>".$ged['Group']."</b></td>
	<td title='".$ged['Days_Before_Prep_Zapusk']."' width='50px'><b>".$ged['Days_Before_Prep_Zapusk~']."</b></td>
	<td title='".$ged['Prep_Zapusk_Date']."' width='70px'><b>".$ged['Prep_Zapusk_Date~']."</b></td>
	<td title='".$ged['Days_Before_Zapusk']."' width='50px'><b>".$ged['Days_Before_Zapusk~']."</b></td>
	<td title='".$ged['Zapusk_Date']."' width='70px'><b>".$ged['Zapusk_Date~']."</b></td>
...
//states [END]
	...
	if (( $state=="pregnant" | ( $state=="insem?" & $insem_dates!="" ) | $state=="insem+" )) {
		...
		$prep_zapusk_Ymd=date( "Y-m-d", mktime( 24*$prep_zapusk_days0, 0, 0, $insem_date_arr[1], $insem_date_arr[2], $insem_date_arr[0] ));
		$zapusk_Ymd=date( "Y-m-d", mktime( 24*$zapusk_days0, 0, 0, $insem_date_arr[1], $insem_date_arr[2], $insem_date_arr[0] ));
	...
	<td $rjust>".$prep_zapusk_date_next."&nbsp;</td>
	<td $rjust>".$zapusk_days."&nbsp;</td>
	<td $rjust>".$zapusk_date_next."&nbsp;</td>
