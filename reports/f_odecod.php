...
m: 16.03.2018 */
				...
				case 8: $url_="care";
					...
					$modif_time=$row[24];
					$params="row17=$row[17]&row7=$row[7]&row8=$row[8]&row9=$row[9]&row10=$row[10]&row13=$row[13]&row14=$row[14]&row15=$row[15]&row16=$row[16]";
					break;
				case 16: $url_="care";
					$v1_4=split( "@", $row[15] );
					$v5_8=split( "@", $row[16] );
				...
				case 64: $url_="mov";
					$dep_id=$row[14];
					$descr=$ged["to_departm."].":&nbsp;<b>$dep[$dep_id]</b>";
					$modif_time=$row[24];
					$params="row14=$dep_id&row17=$row[17]";
					break;
				...
				case 512: $url_="rect";
					...
					$descr=$r5_8;
					$modif_time=$row[24];
					$params="row17=$row[17]&row13=$row[13]&row14=$row[14]&row16=$row[16]";
					break;
