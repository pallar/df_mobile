...
//fix long rows [BEGIN]
	$orow[cwnick]=Str_Cut( $cwnick, 34, $contentCharset ); if ( $orow[conick]==$cwnick ) $cwnick=="";
	$orow[ltname]=Str_Cut( $ltname, 16, $contentCharset ); if ( $orow[ltname]==$ltname ) $ltname=="";
	$orow[grname]=Str_Cut( $grname, 16, $contentCharset ); if ( $orow[grname]==$grname ) $grname=="";
	$orow[sgname]=Str_Cut( $sgname, 16, $contentCharset ); if ( $orow[sgname]==$sgname ) $sgname=="";
//fix long rows [END]
//states [BEGIN]
